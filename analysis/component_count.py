"""
Estimated number of mixture components for the k5model_mixture study.
...
Run from the repo root with the project venv:
    .venv/Scripts/python.exe analysis/component_count.py
"""
...
def _order_samplers(df: pd.DataFrame) -> pd.DataFrame:
    """Apply the canonical sampler ordering (bayesm, nuts, hmc) as an ordered Categorical."""
...
def main() -> None:
    write_tables()
    make_plots()
    print("component-count tables + figures -> analysis/out/k5_results/components/")
